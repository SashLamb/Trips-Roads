                ...
                <div class="trip-content sous-etapes-container d-none" id="sous-etapes-<?= $trip->id ?>">
                    ...
                    <div class="timeline-wrapper">
                        ...
                        foreach ($trip->sub_steps as $subStep) {
                            $pauseValue = '00:00:00';
                            // J'utilise $subStep->duration car $ss->heure est du français. Assure-toi que ton Entity utilise bien 'duration' ou 'heure'.
                                    ...
                                    <div class="step-header">
                                        ...
                                        <?php if ($timelineStep['type'] === 'departure'): ?>
                                            <span class="step-time">
                                                Départ : <strong><?= is_object($timelineStep['time']) ? $timelineStep['time']->format('H:i') : substr($timelineStep['time'], 0, 5) ?></strong>
                                            </span>
                                        <?php else: ?>
